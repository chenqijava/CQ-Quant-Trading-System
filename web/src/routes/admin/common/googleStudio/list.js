...
const getUploadImageProps = (regExpStr = 'txt', type = 'GoogleStudio') => {
...
class MyComponent extends Component {
  ...
  async reset () {
    ...
    this.state.email = ''
    this.state.status = ''
    this.state.type = 'GoogleStudio'
    this.state.pagination.current = 1
    this.setState({ filters: {}, email: '', pagination: this.state.pagination, status: '', type: 'GoogleStudio' })
    this.reload()
  }
  ...
  render() {
    ...
    return (<div>
      <Breadcrumb>
        ...
        <Breadcrumb.BreadcrumbItem>Google AI管理</Breadcrumb.BreadcrumbItem>
      </Breadcrumb>
