...
class MyComponent extends Component {
  ...
  async componentWillMount() {
      this.props.dispatch({ type: 'user/stat' }).then(() => {
      this.reload();
      this.getAllGroup()
      })
  }
  ...
  render() {
        ...
        render: (v, r) => {
          return (
            <div style={{
              ...
              {this.props.user?.role === "admin" ? <Button
                                                                  type="link"
                                                                  style={{
                                                                    padding: 0,
                                                                    minWidth: 'auto',
    ...
    <MyTranslate><ExternalAccountFilter>
      <Breadcrumb>
        ...
        <Breadcrumb.BreadcrumbItem>系统模板库</Breadcrumb.BreadcrumbItem>
      </Breadcrumb>
      <Dialog
            ...
            <div>
              ...
              <div
                ...
                onClick={() => download(`${baseUrl}/export`, {
                  ids:this.state.selectedRowKeys && this.state.selectedRowKeys.length > 0? this.state.selectedRowKeys.join(",") : "" ,type:0
                })}>导出模板
              </div>
